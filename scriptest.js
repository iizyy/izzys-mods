...
//My mod: Ex Nihilo mod
//Custom reactions for existing elements to make everything creatable from basic elements
...
//Helium plus proton makes carbon dioxide
elements.proton.reactions.helium = { "elem1": "carbon_dioxide", "elem2": null, "chance": 0.05 }; //
// Carbon dioxide plus proton makes nitrogen
elements.proton.reactions.carbon_dioxide = { "elem1": "nitrogen", "elem2": null, "chance": 0.05 }; //
// Nitrogen plus proton makes oxygen
elements.proton.reactions.nitrogen = { "elem1": "oxygen", "elem2": null, "chance": 0.05 }; //
//Oxygen plus proton makes neon
elements.proton.reactions.oxygen = { "elem1": "neon", "elem2": null, "chance": 0.05 }; //
//Neon plus proton makes sodium
elements.proton.reactions.neon = { "elem1": "sodium", "elem2": null, "chance": 0.05 }; //
//Sodium plus proton makes aluminum
elements.proton.reactions.sodium = { "elem1": "aluminum", "elem2": null, "chance": 0.05 }; //
// Aluminum plus proton makes sand
elements.proton.reactions.aluminum = { "elem1": "sand", "elem2": null, "chance": 0.05 }; //
// Sand plus proton makes sulfur
elements.proton.reactions.sand = { "elem1": "sulfur", "elem2": null, "chance": 0.05 }; //
//Sulfur plus proton makes calcium
elements.proton.reactions.sulfur = { "elem1": "calcium", "elem2": null, "chance": 0.05 }; //
// Calcium plus proton makes iron (final element in this chain)
elements.proton.reactions.calcium = { "elem1": "iron", "elem2": null, "chance": 0.05 }; //
...
runAfterAutogen(function(){
    ...
    for (var element in elements) {
        if (elements[element].category !== "tools") {
            ...
            elements[element].category = "inventory"; //th
        }
    }
